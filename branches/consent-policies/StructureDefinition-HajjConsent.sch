...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Consent">
      <sch:assert test="count(f:extension[@url = 'https://worldhealthorganization.github.io/smart-ips-pilgrimage/branches/consent-policies/StructureDefinition/ConsentPeriod']) &gt;= 1">extension with URL = 'https://worldhealthorganization.github.io/smart-ips-pilgrimage/branches/consent-policies/StructureDefinition/ConsentPeriod': minimum cardinality of 'extension' is 1</sch:assert>
